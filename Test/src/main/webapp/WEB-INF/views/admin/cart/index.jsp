...
<a href="/admin/products/cartclear" class="btn btn-outline-success ml-1 mb-1">Clear Cart</a>
<a href="/admin/products/home" class="btn btn-outline-info ml-1 mb-1" >Buy more</a>
